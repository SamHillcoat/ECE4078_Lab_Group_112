...
class Robot:
    ...
    def convert_to_wheel_v(self, linear_velocity, angular_velocity):
        left_speed_m = linear_velocity - (self.wheels_width* angular_velocity)/2.0
        rigth_speed_m = linear_velocity + (self.wheels_width*angular_velocity)/2.0

        lv = left_speed_m/self.wheels_scale
        rv = rigth_speed_m/self.wheels_scale
