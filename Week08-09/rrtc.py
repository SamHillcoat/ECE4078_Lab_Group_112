...
class RRTC:
    ...
    def planning(self):
        ...
        #TODO: Complete the planning method ----------------------------------------------------------------
            ...
            nearest_end_node_ind = self.get_nearest_node_index(self.end_node_list, new_node)
            dist, _ = self.calc_distance_and_angle(new_node, self.end_node_list[nearest_end_node_ind])
            ...
            if can_merge:
                if self.is_collision_free(new_node):
                    ...
                    self.start_node_list.append(self.end_node_list[nearest_end_node_ind])
